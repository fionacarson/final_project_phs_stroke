...
rm(activity_hb, discharge_hb_totals)
```
...
mytext_dis_hb <- paste(
    "Health Board: ", sf_hb_stroke_data$HBName,"<br/>", 
    "EASR: ", sf_hb_stroke_data$easr, "<br/>", 
    sep="") %>%
...
pal_dis_hb <- colorNumeric(
  palette = "Purples",
  domain = sf_hb_stroke_data$easr)

discharge_hb_easr <- leaflet(sf_hb_stroke_data) %>% 
  addTiles()  %>% 
